...
model_path = "/Users/saiperam/Desktop/HackUTD/HackUTD-Fall-2024-Project/models/random_forest_50_trees.pkl"  # Change this to your model path
...
def predict_fraud(transaction_data):
    ...
    return "Flagged for suspicion due to unusual activity." if prediction[0] == 1 else "No Suspicious Activity Detected"
